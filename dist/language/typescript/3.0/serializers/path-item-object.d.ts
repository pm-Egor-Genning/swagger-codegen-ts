...
export declare const serializePathItemObject: import("fp-ts/lib/Reader").Reader<import("../../../../utils/ref").ResolveRefContext, (pattern: string, item: PathItemObject, from: Ref<string>, kind: Kind) => Either<Error, SerializedType>>;
